...
public class DeleteMentorAvailabilityCommandHandler(
    SchedulingDbContext dbContext,
    ILogger<DeleteMentorAvailabilityCommandHandler> logger) : IRequestHandler<DeleteMentorAvailabilityCommand, Result<Unit>>
{

    public async Task<Result<Unit>> Handle(DeleteMentorAvailabilityCommand request, CancellationToken cancellationToken)
    {
