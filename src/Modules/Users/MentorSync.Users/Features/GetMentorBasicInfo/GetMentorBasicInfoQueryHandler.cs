...
public class GetMentorBasicInfoQueryHandler(UsersDbContext dbContext, ILogger<GetMentorBasicInfoQueryHandler> logger) : IQueryHandler<GetMentorBasicInfoQuery, MentorBasicInfoResponse>
{
