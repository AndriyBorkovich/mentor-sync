...
internal static class MentorsSeeder
{
	public static async Task SeedAsync(IServiceProvider serviceProvider, ILogger<Worker> logger)
	{
		...
		var industryPositionMappings = new Dictionary<Industry, List<string>>
		{
			{ Industry.WebDevelopment,
				[
					"Frontend Developer", "Backend Developer", "Full Stack Developer", "Web Developer", "UX Engineer",
					"UI Developer"
				]
			},
			...
			{ Industry.CyberSecurity,
				[
					"Security Engineer", "Penetration Tester", "Security Analyst", "Security Architect",
					"Security Consultant"
				]
			},
			{ Industry.CloudComputing,
				["Cloud Architect", "Cloud Engineer", "DevOps Engineer", "Solutions Architect", "Cloud Administrator"]
			},
			{ Industry.DevOps,
				[
			...
			{ Industry.GameDevelopment,
				["Game Developer", "Game Designer", "3D Artist", "Unity Developer", "Game Engine Programmer"]
			},
			{ Industry.ItSupport,
				[
					"IT Support Specialist", "System Administrator", "Network Engineer", "Help Desk Technician",
					"IT Coordinator"
				]
			},
			{ Industry.ArtificialIntelligence,
				[
					"AI Engineer", "Machine Learning Engineer", "AI Research Scientist", "NLP Engineer",
					"AI Product Manager"
				]
			},
			{ Industry.Blockchain,
				[
					"Blockchain Developer", "Smart Contract Engineer", "Blockchain Architect", "Blockchain Consultant",
			...
			{ Industry.EmbeddedSystems,
				[
					"Embedded Systems Engineer", "IoT Developer", "Firmware Engineer", "Hardware Engineer",
					"Embedded Software Developer"
				]
			},
			{ Industry.ItConsulting,
				[
					"IT Consultant", "Technology Strategist", "IT Project Manager", "Business Analyst",
					"Solutions Consultant"
				]
			},
			{ Industry.DatabaseAdministration,
				[
					"Database Administrator", "Database Engineer", "Data Architect", "SQL Developer",
					"Database Reliability Engineer"
				]
			},
			{ Industry.ProjectManagement,
				["Project Manager", "Program Manager", "Scrum Master", "Agile Coach", "Delivery Manager"]
			},
			{ Industry.MobileDevelopment,
				["iOS Developer", "Android Developer", "Mobile Engineer", "React Native Developer", "Flutter Developer"]
			},
			{ Industry.LowCodeNoCode,
				[
					"Low-Code Developer", "Business Process Specialist", "CRM Administrator",
					"No-Code Solution Architect",
					"Digital Transformation Specialist"
				]
			},
			{ Industry.QualityControlAssurance,
				["QA Engineer", "Test Automation Engineer", "QA Analyst", "Quality Assurance Manager", "Test Lead"]
			},
			{ Industry.MachineLearning,
				[
					"Machine Learning Engineer", "ML Operations Engineer", "AI Researcher", "Computer Vision Engineer",
		...
		{
			{ Industry.WebDevelopment, ["JavaScript", "TypeScript", "HTML", "CSS", "PHP", "Python", "Ruby", "Java"] },
			{ Industry.DataScience, ["Python", "R", "SQL", "Julia", "Scala"] },
			{ Industry.CyberSecurity, ["Python", "Shell Scripting", "PowerShell", "C", "C++"] },
			{ Industry.CloudComputing, ["Python", "JavaScript", "TypeScript", "Go", "Powelshell", "Bash"] },
			{ Industry.DevOps, ["Python", "Go", "Shell Scripting", "PowerShell", "Ruby"] },
			{ Industry.GameDevelopment, ["C++", "C#", "JavaScript", "Python", "Lua"] },
			{ Industry.ItSupport, ["Shell Scripting", "PowerShell", "Python", "Batch"] },
			{ Industry.ArtificialIntelligence, ["Python", "R", "C++", "Java", "Julia"] },
			{ Industry.Blockchain, ["Solidity", "JavaScript", "Python", "Go", "Rust"] },
			{ Industry.Networking, ["Python", "Shell Scripting", "PowerShell", "C"] },
			{ Industry.UxUiDesign, ["JavaScript", "TypeScript", "HTML", "CSS"] },
			{ Industry.EmbeddedSystems, ["C", "C++", "Python", "Assembly", "Rust"] },
			{ Industry.ItConsulting, ["SQL", "Python", "JavaScript", "Java", "C#"] },
			{ Industry.DatabaseAdministration, ["SQL", "Python", "PowerShell", "Shell Scripting"] },
			{ Industry.ProjectManagement, [] }, // Often doesn't require programming
            { Industry.MobileDevelopment, ["Swift", "Kotlin", "Java", "Objective-C", "Dart", "JavaScript"] },
			{ Industry.LowCodeNoCode, [] }, // By definition doesn't require programming
            { Industry.QualityControlAssurance, ["Python", "JavaScript", "Java", "C#", "Ruby"] },
			{ Industry.MachineLearning, ["Python", "R", "C++", "Java", "Julia"] }
		};
		...
		var industrySkillsMappings = new Dictionary<Industry, List<string>>
		{
			{ Industry.WebDevelopment,
				[
					"React", "Angular", "Vue.js", "Node.js", "RESTful API", "GraphQL", "Web Security", "CI/CD",
					"Responsive Design", "Webpack", "SASS/LESS", "Git", "Docker"
				]
			},
			{ Industry.DataScience,
				[
					"Machine Learning", "Data Visualization", "Statistical Analysis", "Big Data", "Database Design",
					"Data Mining", "ETL", "Pandas", "NumPy", "Jupyter", "Tableau", "Power BI"
				]
			},
			{ Industry.CyberSecurity,
				[
					"Network Security", "Penetration Testing", "SIEM", "Ethical Hacking", "Risk Assessment",
					"Encryption",
					"Security Auditing", "Vulnerability Assessment", "Firewall Configuration", "Incident Response"
				]
			},
			{ Industry.CloudComputing,
				[
					"AWS", "Azure", "GCP", "Kubernetes", "Docker", "Terraform", "IaaS", "PaaS", "CloudFormation",
					"Serverless", "Microservices", "Load Balancing"
				]
			},
			{ Industry.DevOps,
				[
					"CI/CD", "Docker", "Kubernetes", "Jenkins", "GitLab CI", "GitHub Actions", "Ansible", "Terraform",
					"Monitoring", "Infrastructure as Code", "Observability", "Site Reliability Engineering"
				]
			},
			{ Industry.GameDevelopment,
				[
					"Unity", "Unreal Engine", "3D Modeling", "Animation", "Graphics Programming", "Game Physics",
					"Multiplayer Networking", "Game Design", "Mobile Gaming", "Console Development"
				]
			},
			{ Industry.ItSupport,
				[
					"Troubleshooting", "System Administration", "Network Configuration", "Active Directory",
					"IT Service Management", "Help Desk", "IT Infrastructure", "ITIL", "User Support"
				]
			},
			{ Industry.ArtificialIntelligence,
				[
					"Machine Learning", "Neural Networks", "Deep Learning", "NLP", "Computer Vision", "TensorFlow",
					"PyTorch", "Reinforcement Learning", "AI Ethics", "Feature Engineering"
				]
			},
			{ Industry.Blockchain,
				[
					"Smart Contracts", "Ethereum", "Bitcoin", "Decentralized Applications", "Tokenomics", "Web3",
					"Cryptography", "Consensus Mechanisms", "NFTs", "DeFi"
				]
			},
			{ Industry.Networking,
				[
					"TCP/IP", "Routing", "Switching", "Firewalls", "VPN", "DHCP", "DNS", "Network Security", "Cisco",
					"Load Balancing", "Network Virtualization"
				]
			},
			{ Industry.UxUiDesign,
				[
					"User Research", "Wireframing", "Prototyping", "Usability Testing", "Information Architecture",
					"Design Systems", "Figma", "Adobe XD", "Sketch", "Accessibility", "Interaction Design"
				]
			},
			{ Industry.EmbeddedSystems,
				[
					"Microcontrollers", "RTOS", "Circuit Design", "PCB Design", "IoT", "Firmware Development",
					"Signal Processing", "Low-Level Programming", "Sensors", "Actuators"
				]
			},
			{ Industry.ItConsulting,
				[
					"Business Analysis", "Requirements Gathering", "Solution Architecture", "Project Management",
					"Digital Transformation", "Change Management", "Strategic Planning", "TOGAF",
					"Enterprise Architecture"
				]
			},
			{ Industry.DatabaseAdministration,
				[
					"SQL", "Database Optimization", "Data Modeling", "Database Security", "ETL", "Backup/Recovery",
					"High Availability", "Replication", "PostgreSQL", "MySQL", "MongoDB", "Oracle"
				]
			},
			{ Industry.ProjectManagement,
				[
					"Agile", "Scrum", "Kanban", "Waterfall", "Risk Management", "Stakeholder Management",
					"Resource Allocation", "Budgeting", "JIRA", "MS Project", "Communication", "Leadership"
				]
			},
			{ Industry.MobileDevelopment,
				[
					"iOS Development", "Android Development", "React Native", "Flutter", "Mobile UI Design",
					"App Store Optimization", "Push Notifications", "Mobile Security", "Responsive Design",
					"Cross-platform Development"
				]
			},
			{ Industry.LowCodeNoCode,
				[
					"Bubble.io", "Zapier", "Airtable", "Power Apps", "Microsoft Power Automate", "OutSystems", "Mendix",
					"Business Process Automation", "Workflow Design", "Citizen Development"
				]
			},
			{ Industry.QualityControlAssurance,
				[
					"Test Automation", "Selenium", "Cypress", "JUnit", "TestNG", "Manual Testing", "API Testing",
					"Performance Testing", "Security Testing", "Bug Tracking", "Test Plans", "Quality Metrics"
				]
			},
			{ Industry.MachineLearning,
				[
					"TensorFlow", "PyTorch", "Scikit-learn", "Feature Engineering", "Model Optimization",
					"Data Preprocessing", "MLOps", "Neural Networks", "Computer Vision", "NLP", "Reinforcement Learning"
				]
			}
		};
		...
		for (var i = 0; i < 100; i++)
		{
			...
			if (primaryIndustry != Industry.None)
			{
				...
				var isSeniorPosition = mentorProfile.Position.Contains("Senior", StringComparison.InvariantCulture) ||
									   mentorProfile.Position.Contains("Lead", StringComparison.InvariantCulture) ||
									   mentorProfile.Position.Contains("Manager", StringComparison.InvariantCulture) ||
									   mentorProfile.Position.Contains("Architect", StringComparison.InvariantCulture) ||
									   mentorProfile.Position.Contains("Director", StringComparison.InvariantCulture) ||
